...
# Required packages
sudo apt install neovim neofetch firefox-esr grim slurp imv bc libreoffice thunderbird cups libreoffice-lightproof-en chromium heif-gdk-pixbuf timeshift mixxxinkscape gimp bleachbit vlc vlc-plugin-pipewire 
